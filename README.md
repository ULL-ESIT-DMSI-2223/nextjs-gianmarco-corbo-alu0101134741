...
![paginaPetjs]({{ "/assets/images/paginaPetjs.png" | relative_url }})
...
![generateImagejs]({{ "/assets/images/generateImagejs.png" | relative_url }})
...
![imagejs]({{ "/assets/images/imagejs.png" | relative_url }})

![paginaImagejs]({{ "/assets/images/paginaImagejs.png" | relative_url }})

Añadimos en el archivo **index.js** el enlace a la ruta **/image**. <br>

![indexjs]({{ "/assets/images/indexjs.png" | relative_url }})
